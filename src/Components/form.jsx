...
const initialValues = { username: "", email: "", password: "" , message: ""};
  ...
  return (
    <div className="back">
          <br></br>
          <br></br>
          <h1 className="fh1">QUICK CONTACT</h1>
        <br></br>
    ...
    />
     ...
     <p className="fp">{formErrors.username}</p>
    ...
    class="form-control" id="exampleFormControlInput1" 
              ...
              onChange={handleChange}
            />
             <p className="fp">{formErrors.email}</p>
            ...
            <input
             class="form-control" id="exampleFormControlInput1" 
              ...
              onChange={handleChange}
            />
            <p className="fp">{formErrors.phone}</p>
            ...
            <button  className=" fbtn" type="submit" ><b>SEND</b></button>
